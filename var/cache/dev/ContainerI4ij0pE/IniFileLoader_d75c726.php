...
{
    /**
     * @var \Symfony\Component\Translation\Loader\IniFileLoader|null wrapped object, if the proxy is initialized
     */
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Symfony\\Component\\Translation\\Loader\\IniFileLoader');
...
if (!\class_exists('IniFileLoader_d75c726', false)) {
    \class_alias(__NAMESPACE__.'\\IniFileLoader_d75c726', 'IniFileLoader_d75c726', false);
}
