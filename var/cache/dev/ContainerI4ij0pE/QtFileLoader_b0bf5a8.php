...
{
    /**
     * @var \Symfony\Component\Translation\Loader\QtFileLoader|null wrapped object, if the proxy is initialized
     */
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Symfony\\Component\\Translation\\Loader\\QtFileLoader');
...
if (!\class_exists('QtFileLoader_b0bf5a8', false)) {
    \class_alias(__NAMESPACE__.'\\QtFileLoader_b0bf5a8', 'QtFileLoader_b0bf5a8', false);
}
