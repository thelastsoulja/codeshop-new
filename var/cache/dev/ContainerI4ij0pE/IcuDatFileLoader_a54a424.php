...
class IcuDatFileLoader_a54a424 extends \Symfony\Component\Translation\Loader\IcuDatFileLoader implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializerbd7be && ($this->initializerbd7be->__invoke($valueHolderdfe5e, $this, 'load', array('resource' => $resource, 'locale' => $locale, 'domain' => $domain), $this->initializerbd7be) || 1) && $this->valueHolderdfe5e = $valueHolderdfe5e;

        return $this->valueHolderdfe5e->load($resource, $locale, $domain);
    }
