 ...
 */
class PaymentMethod extends \Sylius\Component\Core\Model\PaymentMethod implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     * {@inheritDoc}
     */
    public function setGatewayConfig(?\Payum\Core\Model\GatewayConfigInterface $gateway): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGatewayConfig', [$gateway]);

        parent::setGatewayConfig($gateway);
    }
