...
class __TwigTemplate_a0e3a13da2fc0f2ed44c0713ca27012012176cbcaf158085c9d77e7abd2a57d0 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_subject($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("sylius.email.shipment_confirmation.subject", [], null, (isset($context["localeCode"]) || array_key_exists("localeCode", $context) ? $context["localeCode"] : (function () { throw new RuntimeError('Variable "localeCode" does not exist.', 4, $this->source); })()));
        echo "
";
...
{% endblock %}
", "@SyliusCore/Email/shipmentConfirmation.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/CoreBundle/Resources/views/Email/shipmentConfirmation.html.twig");
    }
}
