...
class __TwigTemplate_9c84bf699a612c54bf23d584f54e086a699bdef657814edf92aa6d37e79604e5 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"sylius-grid-nav\">
    ";
        ...
        if ((((twig_length_filter($this->env, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 4, $this->source); })())) > 0) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["definition"] ?? null), "actionGroups", [], "any", false, true, false, 4), "bulk", [], "any", true, true, false, 4)) && (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["definition"]) || array_key_exists("definition", $context) ? $context["definition"] : (function () { throw new RuntimeError('Variable "definition" does not exist.', 4, $this->source); })()), "getEnabledActions", ["bulk"], "method", false, false, false, 4)) > 0))) {
            ...
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["definition"]) || array_key_exists("definition", $context) ? $context["definition"] : (function () { throw new RuntimeError('Variable "definition" does not exist.', 6, $this->source); })()), "getEnabledActions", ["bulk"], "method", false, false, false, 6));
...
", "@SyliusUi/Grid/Body/_navigation.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/UiBundle/Resources/views/Grid/Body/_navigation.html.twig");
    }
}
