...
class __TwigTemplate_2daf1266d4eec84865ff2600d3571fcd741e32947dd59025fc56a00fdc28b4a1 extends Template
{
    private $source;
    private $macros = [];
...
";
            ...
            echo "\" ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["item"]) || array_key_exists("item", $context) ? $context["item"] : (function () { throw new RuntimeError('Variable "item" does not exist.', 45, $this->source); })()), "linkAttributes", [], "any", false, false, false, 45));
            foreach ($context['_seq'] as $context["linkAttributeName"] => $context["linkAttributeValue"]) {
                echo twig_escape_filter($this->env, $context["linkAttributeName"], "html", null, true);
                echo "=\"";
                echo twig_escape_filter($this->env, $context["linkAttributeValue"], "html", null, true);
                echo "\"";
            }
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['linkAttributeName'], $context['linkAttributeValue'], $context['_parent'], $context['loop']);
            $context = array_intersect_key($context, $_parent) + $_parent;
            echo ">
    ";
            // line 46
...
";
    ...
    public function block_icon($context, array $blocks = [])
    {
        ...
        // line 53
        $context["icon"] = twig_get_attribute($this->env, $this->source, (isset($context["item"]) || array_key_exists("item", $context) ? $context["item"] : (function () { throw new RuntimeError('Variable "item" does not exist.', 53, $this->source); })()), "labelAttribute", ["icon"], "method", false, false, false, 53);
        // line 54
    ...
    {
        return array (  240 => 54,  238 => 53,  228 => 52,  214 => 47,  210 => 46,  189 => 45,  182 => 41,  177 => 39,  170 => 38,  168 => 37,  165 => 35,  163 => 34,  161 => 33,  158 => 30,  156 => 29,  153 => 28,  151 => 27,  148 => 26,  146 => 25,  143 => 23,  140 => 21,  138 => 20,  135 => 18,  133 => 17,  130 => 15,  128 => 14,  126 => 13,  124 => 12,  122 => 11,  112 => 9,  87 => 5,  70 => 4,  60 => 3,  37 => 1,);
    }
...
", "@SyliusUi/Menu/sidebar.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/UiBundle/Resources/views/Menu/sidebar.html.twig");
    }
}
