...
class __TwigTemplate_8c80d5ae783359a7a5b6d993781b1e692eb424717051659072f4402bc1608af8 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_subcontent($context, array $blocks = [])
    {
        ...
        // line 8
        echo "    <div class=\"ui stackable two column grid\" style=\"margin-bottom: 30px;\">
        <div class=\"column\">
            <h1 class=\"ui header\">
                ";
        // line 11
    ...
    ";
        ...
        ";
            // line 27
            if ( !(null === (isset($context["default_address"]) || array_key_exists("default_address", $context) ? $context["default_address"] : (function () { throw new RuntimeError('Variable "default_address" does not exist.', 27, $this->source); })()))) {
                // line 28
                echo "            ";
                $this->loadTemplate("@SyliusShop/Account/AddressBook/_defaultAddress.html.twig", "@SyliusShop/Account/AddressBook/index.html.twig", 28)->display(twig_array_merge($context, ["address" => (isset($context["default_address"]) || array_key_exists("default_address", $context) ? $context["default_address"] : (function () { throw new RuntimeError('Variable "default_address" does not exist.', 28, $this->source); })())]));
                // line 29
                echo "        ";
            }
            // line 30
            echo "        <div class=\"address-cards\" id=\"sylius-addresses\" ";
            echo $this->env->getFunction('sylius_test_html_attribute')->getCallable()("addresses");
            echo ">
            ";
            // line 31
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_array_filter($this->env, (isset($context["addresses"]) || array_key_exists("addresses", $context) ? $context["addresses"] : (function () { throw new RuntimeError('Variable "addresses" does not exist.', 31, $this->source); })()), function ($__address__) use ($context, $macros) { $context["address"] = $__address__; return ((null === (isset($context["default_address"]) || array_key_exists("default_address", $context) ? $context["default_address"] : (function () { throw new RuntimeError('Variable "default_address" does not exist.', 31, $this->source); })())) || (twig_get_attribute($this->env, $this->source, $context["address"], "id", [], "any", false, false, false, 31) != twig_get_attribute($this->env, $this->source, (isset($context["default_address"]) || array_key_exists("default_address", $context) ? $context["default_address"] : (function () { throw new RuntimeError('Variable "default_address" does not exist.', 31, $this->source); })()), "id", [], "any", false, false, false, 31))); }));
            $context['loop'] = [
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["address"]) {
                // line 32
                echo "                ";
                $this->loadTemplate("@SyliusShop/Account/AddressBook/_item.html.twig", "@SyliusShop/Account/AddressBook/index.html.twig", 32)->display($context);
                // line 33
                echo "            ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
    ...
    ";
            ...
            // line 36
            echo "        ";
            echo twig_call_macro($macros["messages"], "macro_info", ["sylius.ui.you_have_no_addresses_defined"], 36, $context, $this->getSourceContext());
            echo "
    ";
        }
    ...
    {
        return array (  187 => 36,  183 => 34,  169 => 33,  166 => 32,  149 => 31,  144 => 30,  141 => 29,  138 => 28,  136 => 27,  133 => 26,  130 => 25,  128 => 24,  121 => 20,  114 => 18,  108 => 15,  102 => 12,  98 => 11,  93 => 8,  83 => 7,  62 => 5,  51 => 1,  49 => 3,  36 => 1,);
    }
...
{% block subcontent %}
    ...
    {% endif %}
{% endblock %}
", "@SyliusShop/Account/AddressBook/index.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Account/AddressBook/index.html.twig");
    }
}
