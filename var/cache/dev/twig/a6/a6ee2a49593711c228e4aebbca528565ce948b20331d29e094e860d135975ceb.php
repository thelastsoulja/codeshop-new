...
class __TwigTemplate_271fc8814f46cd52903cffd316a0cf643ba4d31bd3801cd8f1f42df42c0c2983 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 3
        $macros["__internal_parse_52"] = $this->macros["__internal_parse_52"] = $this;
        // line 1
    ...
    ";
        ...
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 210, $this->source); })()), "data", [], "any", false, false, false, 210), "forms", [], "any", false, false, false, 210))) {
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 214
                echo "                ";
                echo twig_call_macro($macros["__internal_parse_52"], "macro_form_tree_entry", [$context["formName"], $context["formData"], true], 214, $context, $this->getSourceContext());
                echo "
            ";
            }
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "/var/www/html/Sylius/vendor/symfony/web-profiler-bundle/Resources/views/Collector/form.html.twig");
    }
}
