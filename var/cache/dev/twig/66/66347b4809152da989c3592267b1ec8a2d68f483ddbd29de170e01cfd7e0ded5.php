...
class __TwigTemplate_9f05c4645329d85274a42b9c131651f4e2e8b2382dfce259fcfdd8399b7898e3 extends Template
{
    private $source;
    private $macros = [];
...
{% macro info(text) %}
    ...
    {{ alert(text, 'info') }}
{% endmacro %}
", "@SyliusResource/Macros/notification.html.twig", "/var/www/html/Sylius/vendor/sylius/resource-bundle/src/Bundle/Resources/views/Macros/notification.html.twig");
    }
}
