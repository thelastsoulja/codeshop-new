...
class __TwigTemplate_46539ae834e2be7aabd7ad24e0171e1b0a65680128917073884a150239e67471 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_collection_widget($context, array $blocks = [])
    {
        ...
        // line 4
        $macros["__internal_parse_0"] = $this->loadTemplate("@SyliusResource/Macros/notification.html.twig", "@SyliusUi/Form/imagesTheme.html.twig", 4)->unwrap();
        // line 5
        echo "    ";
        $macros["self"] = $this;
        // line 6
    ...
    ";
        ...
        echo ">
            ";
        // line 15
        echo twig_call_macro($macros["__internal_parse_0"], "macro_error", [twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), "vars", [], "any", false, false, false, 15), "errors", [], "any", false, false, false, 15)], 15, $context, $this->getSourceContext());
        echo "

            ";
        // line 17
        if (is_iterable(((array_key_exists("prototypes", $context)) ? (_twig_default_filter((isset($context["prototypes"]) || array_key_exists("prototypes", $context) ? $context["prototypes"] : (function () { throw new RuntimeError('Variable "prototypes" does not exist.', 17, $this->source); })()))) : ("")))) {
            // line 18
            echo "                ";
...
{% block sylius_avatar_image_widget %}
    ...
    {% endapply %}
{% endblock %}
", "@SyliusUi/Form/imagesTheme.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/UiBundle/Resources/views/Form/imagesTheme.html.twig");
    }
}
