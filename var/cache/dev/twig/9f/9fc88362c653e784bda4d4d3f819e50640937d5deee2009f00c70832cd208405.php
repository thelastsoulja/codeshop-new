...
class __TwigTemplate_a7149fdddd631efe6668713ed0add8ec8405f5629d90bd1f829676cb6c09c824 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["catalog_promotion"]) || array_key_exists("catalog_promotion", $context) ? $context["catalog_promotion"] : (function () { throw new RuntimeError('Variable "catalog_promotion" does not exist.', 9, $this->source); })()), "exclusive", [], "any", false, false, false, 9)) {
            ...
            echo $this->env->getFunction('sylius_test_html_attribute')->getCallable()("exclusive");
...
", "@SyliusAdmin/CatalogPromotion/Show/_details.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/AdminBundle/Resources/views/CatalogPromotion/Show/_details.html.twig");
    }
}
