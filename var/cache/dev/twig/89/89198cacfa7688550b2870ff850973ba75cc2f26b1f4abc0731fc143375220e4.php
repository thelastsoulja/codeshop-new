...
class __TwigTemplate_e699242ec43e3469f2bdacd3da0cf3dd86c01cada64820a68fde94575f81e7ed extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            ...
            if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["taxon"]) || array_key_exists("taxon", $context) ? $context["taxon"] : (function () { throw new RuntimeError('Variable "taxon" does not exist.', 4, $this->source); })()), "enabledChildren", [], "any", false, false, false, 4)) > 0)) {
                ...
                echo $this->env->getFunction('sylius_test_html_attribute')->getCallable()("menu-item", twig_get_attribute($this->env, $this->source, (isset($context["taxon"]) || array_key_exists("taxon", $context) ? $context["taxon"] : (function () { throw new RuntimeError('Variable "taxon" does not exist.', 5, $this->source); })()), "name", [], "any", false, false, false, 5));
                echo ">
            <span class=\"text\">";
                // line 6
    ...
    ";
                ...
                echo "\" class=\"item\" ";
                echo $this->env->getFunction('sylius_test_html_attribute')->getCallable()("menu-item", twig_get_attribute($this->env, $this->source, (isset($context["taxon"]) || array_key_exists("taxon", $context) ? $context["taxon"] : (function () { throw new RuntimeError('Variable "taxon" does not exist.', 15, $this->source); })()), "name", [], "any", false, false, false, 15));
                echo ">";
...
{% endif %}
", "@SyliusShop/Taxon/_horizontalMenu.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Taxon/_horizontalMenu.html.twig");
    }
}
