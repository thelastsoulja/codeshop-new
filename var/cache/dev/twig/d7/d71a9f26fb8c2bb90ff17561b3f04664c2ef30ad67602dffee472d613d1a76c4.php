...
class __TwigTemplate_cb01abf3259f25d8ca20bafb58a9a68ceae6e3de2f4503d0ddeef9ac4f837ae0 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_previous_page_message($context, array $blocks = [])
    {
        ...
        // line 4
        $macros["__internal_parse_21"] = $this->loadTemplate("@BabDevPagerfanta/macros.html.twig", "@BabDevPagerfanta/default.html.twig", 4)->unwrap();
        // line 5
        echo twig_call_macro($macros["__internal_parse_21"], "macro_resolve_previous_page_message", [(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 5, $this->source); })())], 5, $context, $this->getSourceContext());
    ...
    public function block_next_page_message($context, array $blocks = [])
    {
        ...
        // line 9
        $macros["__internal_parse_22"] = $this->loadTemplate("@BabDevPagerfanta/macros.html.twig", "@BabDevPagerfanta/default.html.twig", 9)->unwrap();
        // line 10
        echo twig_call_macro($macros["__internal_parse_22"], "macro_resolve_next_page_message", [(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 10, $this->source); })())], 10, $context, $this->getSourceContext());
...
", "@BabDevPagerfanta/default.html.twig", "/var/www/html/Sylius/vendor/babdev/pagerfanta-bundle/templates/default.html.twig");
    }
}
