...
class __TwigTemplate_3aa65d96ad95f9975e00e7d9792c4ee48704cbfa817e065383312659b70f0331 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_dump_request_data($__token__ = null, $__events__ = null, $__origin__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 156
            $macros["__internal_parse_53"] = $this;
            // line 157
            echo "{
    id: \"";
            // line 158
    ...
    events: [ ";
            // line 161
            echo twig_call_macro($macros["__internal_parse_53"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 161, $this->source); })())], 161, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "/var/www/html/Sylius/vendor/symfony/web-profiler-bundle/Resources/views/Collector/time.html.twig");
    }
}
