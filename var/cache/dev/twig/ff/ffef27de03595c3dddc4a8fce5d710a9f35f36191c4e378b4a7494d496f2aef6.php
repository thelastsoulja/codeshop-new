...
class __TwigTemplate_fd266bbd24c2696e5b26bf0880562079627c89bad8b038224d4c5fa059f47bbd extends Template
{
    private $source;
    private $macros = [];
    ...
    <td colspan=\"";
        ...
        if ( !twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 22, $this->source); })()), "adjustments", [(isset($context["shippingAdjustment"]) || array_key_exists("shippingAdjustment", $context) ? $context["shippingAdjustment"] : (function () { throw new RuntimeError('Variable "shippingAdjustment" does not exist.', 22, $this->source); })())], "method", false, false, false, 22), "isEmpty", [], "method", false, false, false, 22)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["shipment"]) {
                ...
                // line 37
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["shipment"], "adjustments", [(isset($context["taxAdjustment"]) || array_key_exists("taxAdjustment", $context) ? $context["taxAdjustment"] : (function () { throw new RuntimeError('Variable "taxAdjustment" does not exist.', 37, $this->source); })())], "method", false, false, false, 37));
                foreach ($context['_seq'] as $context["_key"] => $context["adjustment"]) {
                    // line 38
                    echo "                        <div class=\"item";
...
", "@SyliusAdmin/Order/Show/Summary/_totals.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Order/Show/Summary/_totals.html.twig");
    }
}
