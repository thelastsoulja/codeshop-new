...
class __TwigTemplate_b4746182d7af44fae80228f9faad296e2f77350a7ab6733efbe0b64705588d51 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"thirteen wide column\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 23
            echo "                ";
            $this->loadTemplate(twig_get_attribute($this->env, $this->source, $context["item"], "attribute", ["template"], "method", false, false, false, 23), "@SyliusAdmin/Product/_menu.html.twig", 23)->display(twig_array_merge($context, ["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 23, $this->source); })()), "product" => twig_get_attribute($this->env, $this->source, (isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 23, $this->source); })()), "product", [], "any", false, false, false, 23)]));
            // line 24
            echo "            ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
{% endblock %}
", "@SyliusAdmin/Product/_menu.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Product/_menu.html.twig");
    }
}
