...
class __TwigTemplate_e20e3460b3607a475c579ddf1e3cfe7c9d30bfdc5b0981f6527e8c739262e8ce extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 8
        echo "    ";
        echo $this->extensions['Sylius\Bundle\UiBundle\Twig\TemplateEventExtension']->render(["sylius.shop.checkout.complete.steps", "sylius.shop.checkout.steps"], twig_array_merge($context, ["active" => "complete", "orderTotal" => twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 8, $this->source); })()), "total", [], "any", false, false, false, 8)]));
        echo "
...
{% endblock %}
", "@SyliusShop/Checkout/complete.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Checkout/complete.html.twig");
    }
}
