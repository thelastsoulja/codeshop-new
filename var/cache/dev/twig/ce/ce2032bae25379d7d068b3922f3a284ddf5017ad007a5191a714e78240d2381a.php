...
class __TwigTemplate_18ea25c5c2fd6c34d49923d50a1d72ace09805055af45439a265a8d49ef60cf6 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        if ( !(null === twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 1, $this->source); })()), "notes", [], "any", false, false, false, 1))) {
            // line 2
    ...
    <div class=\"ui attached segment\" id=\"sylius-order-notes\">
        ";
            // line 6
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 6, $this->source); })()), "notes", [], "any", false, false, false, 6), "html", null, true);
            echo "
    </div>
";
        }
...
{% endif %}
", "@SyliusAdmin/Order/Show/_notes.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Order/Show/_notes.html.twig");
    }
}
