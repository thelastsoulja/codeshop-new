...
class __TwigTemplate_6ba058c9fbc406fc237393bfbae86b4a82a9d3d858d274228a6f20c72e421ade extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        $macros["__internal_parse_46"] = $this->macros["__internal_parse_46"] = $this->loadTemplate("@SyliusAdmin/Macro/translationForm.html.twig", "@SyliusAdmin/ShippingMethod/_form.html.twig", 1)->unwrap();
        // line 2
        echo "
<div class=\"ui two column stackable grid\">
    <div class=\"column\">
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "configuration", [], "any", true, true, false, 30)) {
            // line 31
            echo "                    ";
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 31, $this->source); })()), "configuration", [], "any", false, false, false, 31), 'widget');
            echo "
                ";
        }
        // line 33
        ...
        echo "</h4>
            <div id=\"rules\">
                ";
        // line 37
        $this->loadTemplate("@SyliusAdmin/ShippingMethod/_rules.html.twig", "@SyliusAdmin/ShippingMethod/_form.html.twig", 37)->display($context);
        // line 38
        echo "            </div>
        </div>
    </div>
    <div class=\"column\">
        ";
        // line 42
        echo twig_call_macro($macros["__internal_parse_46"], "macro_translationForm", [twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 42, $this->source); })()), "translations", [], "any", false, false, false, 42)], 42, $context, $this->getSourceContext());
        echo "
    </div>
</div>
";
    ...
    {
        return array (  167 => 42,  161 => 38,  159 => 37,  154 => 35,  150 => 33,  144 => 31,  142 => 30,  139 => 29,  130 => 26,  123 => 25,  119 => 24,  115 => 23,  111 => 22,  107 => 21,  102 => 20,  93 => 18,  89 => 17,  85 => 16,  81 => 15,  77 => 14,  73 => 13,  69 => 12,  64 => 10,  60 => 9,  56 => 8,  51 => 6,  45 => 2,  43 => 1,);
    }
...
", "@SyliusAdmin/ShippingMethod/_form.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/AdminBundle/Resources/views/ShippingMethod/_form.html.twig");
    }
}
