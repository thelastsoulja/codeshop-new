...
class __TwigTemplate_2594789621598d672aa88b902967a7023c234e5b9aca86132bc8b095b330aa5d extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"ui segment\">
    ";
        ...
        echo "</button>
            ";
        // line 9
        $this->loadTemplate("@SyliusUi/Form/Buttons/_cancel.html.twig", "@SyliusAdmin/ProductVariant/Generate/_content.html.twig", 9)->display(twig_array_merge($context, ["path" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath(twig_get_attribute($this->env, $this->source, (isset($context["configuration"]) || array_key_exists("configuration", $context) ? $context["configuration"] : (function () { throw new RuntimeError('Variable "configuration" does not exist.', 9, $this->source); })()), "getRouteName", ["index"], "method", false, false, false, 9), ["productId" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 9, $this->source); })()), "id", [], "any", false, false, false, 9)])]));
        // line 10
        echo "        </div>
    </div>
    ";
...
", "@SyliusAdmin/ProductVariant/Generate/_content.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/AdminBundle/Resources/views/ProductVariant/Generate/_content.html.twig");
    }
}
