...
class __TwigTemplate_e8b708338b1a61be666fa57b78ebd94fec20089589f0754766e560da1a44935c extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 3
        $context["itemsSubtotal"] = twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 3, $this->source); })()), "getItemsSubtotal", [], "method", false, false, false, 3);
        // line 4
        $context["taxIncluded"] = twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 4, $this->source); })()), "getTaxIncludedTotal", [], "method", false, false, false, 4);
        // line 5
        $context["taxExcluded"] = twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 5, $this->source); })()), "getTaxExcludedTotal", [], "method", false, false, false, 5);
        // line 6
        echo "
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 65, $this->source); })()), "shipments", [], "any", false, false, false, 65))) {
            ...
            echo ":</strong>
                    ...
                    <td colspan=\"2\" class=\"right aligned\">
                        ";
            // line 71
            if ((twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 71, $this->source); })()), "getAdjustmentsTotal", ["shipping"], "method", false, false, false, 71) > twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 71, $this->source); })()), "shippingTotal", [], "any", false, false, false, 71))) {
                // line 72
                echo "                            <div class=\"old-price\">";
                echo twig_call_macro($macros["money"], "macro_convertAndFormat", [twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 72, $this->source); })()), "getAdjustmentsTotal", ["shipping"], "method", false, false, false, 72)], 72, $context, $this->getSourceContext());
                echo "</div>
                        ";
            }
            // line 74
...
";
    ...
    {
        return array (  235 => 83,  229 => 80,  225 => 78,  217 => 74,  211 => 72,  209 => 71,  203 => 68,  199 => 66,  197 => 65,  191 => 62,  185 => 59,  179 => 55,  173 => 52,  169 => 51,  166 => 50,  163 => 49,  157 => 47,  154 => 46,  148 => 44,  146 => 43,  140 => 40,  133 => 38,  127 => 35,  121 => 32,  115 => 28,  105 => 24,  99 => 23,  94 => 21,  90 => 20,  86 => 19,  83 => 18,  79 => 17,  72 => 13,  68 => 12,  64 => 11,  58 => 8,  54 => 6,  52 => 5,  50 => 4,  48 => 3,  45 => 2,  43 => 1,);
    }
...
", "@SyliusShop/Checkout/_summary.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Checkout/_summary.html.twig");
    }
}
