...
class __TwigTemplate_7c8921a00fe45c6a7298927b16e689394b43a5eef793e7291f0236da5424777b extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"ui stackable two column grid\">
    ...
    <div class=\"four wide right aligned column\">
        ";
        // line 8
        echo twig_call_macro($macros["buttons"], "macro_default", [twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 8, $this->source); })()), "request", [], "any", false, false, false, 8), "headers", [], "any", false, false, false, 8), "get", ["referer"], "method", false, false, false, 8), "", "back", "arrow alternate circle left outline"], 8, $context, $this->getSourceContext());
        echo "
    </div>
</div>
";
...
", "@SyliusAdmin/Shipment/Show/_headerWidget.html.twig", "/var/www/html/Sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Shipment/Show/_headerWidget.html.twig");
    }
}
