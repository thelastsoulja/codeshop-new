...
{
    /**
     * @var \Symfony\Component\Translation\Loader\IcuDatFileLoader|null wrapped object, if the proxy is initialized
     */
    ...
    {
        $this->initializer55bb9 && ($this->initializer55bb9->__invoke($valueHolder99a5c, $this, 'load', array('resource' => $resource, 'locale' => $locale, 'domain' => $domain), $this->initializer55bb9) || 1) && $this->valueHolder99a5c = $valueHolder99a5c;

        return $this->valueHolder99a5c->load($resource, $locale, $domain);
    }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Symfony\\Component\\Translation\\Loader\\IcuDatFileLoader');
...
if (!\class_exists('IcuDatFileLoader_a54a424', false)) {
    \class_alias(__NAMESPACE__.'\\IcuDatFileLoader_a54a424', 'IcuDatFileLoader_a54a424', false);
}
