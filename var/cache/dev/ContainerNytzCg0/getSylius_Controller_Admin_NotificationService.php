...
class getSylius_Controller_Admin_NotificationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.controller.admin.notification'] = new \Sylius\Bundle\AdminBundle\Controller\NotificationController(($container->privates['psr18.http_client'] ?? $container->load('getPsr18_HttpClientService')), $a, 'https://gus.sylius.com/version', 'dev', $a);
    }
}
