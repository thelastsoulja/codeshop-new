...
class TranslationConfig 
{
    ...
    public function classes(array $value = []): \Symfony\Config\SyliusPromotion\Resources\Promotion\Translation\ClassesConfig
    {
        if (null === $this->classes) {
            $this->_usedProperties['classes'] = true;
            $this->classes = new \Symfony\Config\SyliusPromotion\Resources\Promotion\Translation\ClassesConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('classes', $value)) {
            $this->_usedProperties['classes'] = true;
            $this->classes = new \Symfony\Config\SyliusPromotion\Resources\Promotion\Translation\ClassesConfig($value['classes']);
            unset($value['classes']);
        }
