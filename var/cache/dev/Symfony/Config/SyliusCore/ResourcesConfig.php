...
require_once __DIR__.\DIRECTORY_SEPARATOR.'Resources'.\DIRECTORY_SEPARATOR.'ChannelPricingLogEntryConfig.php';
require_once __DIR__.\DIRECTORY_SEPARATOR.'Resources'.\DIRECTORY_SEPARATOR.'ShopBillingDataConfig.php';
require_once __DIR__.\DIRECTORY_SEPARATOR.'Resources'.\DIRECTORY_SEPARATOR.'ChannelPriceHistoryConfigConfig.php';
...
class ResourcesConfig 
{
    ...
    private $channelPricingLogEntry;
    private $shopBillingData;
    private $channelPriceHistoryConfig;
    ...
    public function channelPricingLogEntry(array $value = []): \Symfony\Config\SyliusCore\Resources\ChannelPricingLogEntryConfig
    {
        if (null === $this->channelPricingLogEntry) {
            $this->_usedProperties['channelPricingLogEntry'] = true;
            $this->channelPricingLogEntry = new \Symfony\Config\SyliusCore\Resources\ChannelPricingLogEntryConfig($value);
        } elseif (0 < \func_num_args()) {
            throw new InvalidConfigurationException('The node created by "channelPricingLogEntry()" has already been initialized. You cannot pass values the second time you call channelPricingLogEntry().');
        }

        return $this->channelPricingLogEntry;
    }
    ...
    public function channelPriceHistoryConfig(array $value = []): \Symfony\Config\SyliusCore\Resources\ChannelPriceHistoryConfigConfig
    {
        if (null === $this->channelPriceHistoryConfig) {
            $this->_usedProperties['channelPriceHistoryConfig'] = true;
            $this->channelPriceHistoryConfig = new \Symfony\Config\SyliusCore\Resources\ChannelPriceHistoryConfigConfig($value);
        } elseif (0 < \func_num_args()) {
            throw new InvalidConfigurationException('The node created by "channelPriceHistoryConfig()" has already been initialized. You cannot pass values the second time you call channelPriceHistoryConfig().');
        }
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('channel_pricing_log_entry', $value)) {
            $this->_usedProperties['channelPricingLogEntry'] = true;
            $this->channelPricingLogEntry = new \Symfony\Config\SyliusCore\Resources\ChannelPricingLogEntryConfig($value['channel_pricing_log_entry']);
            unset($value['channel_pricing_log_entry']);
        }
        ...
        if (array_key_exists('channel_price_history_config', $value)) {
            $this->_usedProperties['channelPriceHistoryConfig'] = true;
            $this->channelPriceHistoryConfig = new \Symfony\Config\SyliusCore\Resources\ChannelPriceHistoryConfigConfig($value['channel_price_history_config']);
            unset($value['channel_price_history_config']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['channelPricingLogEntry'])) {
            $output['channel_pricing_log_entry'] = $this->channelPricingLogEntry->toArray();
        }
        if (isset($this->_usedProperties['shopBillingData'])) {
            $output['shop_billing_data'] = $this->shopBillingData->toArray();
        }
        if (isset($this->_usedProperties['channelPriceHistoryConfig'])) {
            $output['channel_price_history_config'] = $this->channelPriceHistoryConfig->toArray();
        }
