 ...
 */
class getSylius_Api_OrderShippingMethodFilterService extends App_KernelTestDebugContainer
{
    /**
     * Gets the public 'sylius.api.order_shipping_method_filter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sylius.api.order_shipping_method_filter'])) {
            return $container->services['sylius.api.order_shipping_method_filter'];
        }

        return $container->services['sylius.api.order_shipping_method_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), NULL, $a, ($container->privates['property_accessor'] ?? $container->getPropertyAccessorService()), ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()), ['shipments.method.code' => 'exact'], ($container->privates['api_platform.identifiers_extractor.cached'] ?? $container->getApiPlatform_IdentifiersExtractor_CachedService()), ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
