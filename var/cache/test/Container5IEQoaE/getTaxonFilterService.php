 ...
 */
class getTaxonFilterService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/ApiBundle/Filter/Doctrine/TaxonFilter.php';
        ...
        return $container->services['Sylius\\Bundle\\ApiBundle\\Filter\\Doctrine\\TaxonFilter'] = new \Sylius\Bundle\ApiBundle\Filter\Doctrine\TaxonFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), $a);
    }
}
