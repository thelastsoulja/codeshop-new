 ...
 */
class getSylius_Api_OrderFilter_NameService extends App_KernelTestDebugContainer
{
    /**
     * Gets the public 'sylius.api.order_filter.name' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.api.order_filter.name'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\OrderFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), NULL, 'order', ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()), ['name' => ''], ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
