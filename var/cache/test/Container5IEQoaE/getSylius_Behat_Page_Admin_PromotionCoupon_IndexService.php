 ...
 */
class getSylius_Behat_Page_Admin_PromotionCoupon_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.promotion_coupon.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\PromotionCoupon\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/PromotionCoupon/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/PromotionCoupon/IndexPage.php';
