 ...
 */
class getSylius_EmailManager_ContactService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/ShopBundle/EmailManager/ContactEmailManagerInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/ShopBundle/EmailManager/ContactEmailManager.php';
