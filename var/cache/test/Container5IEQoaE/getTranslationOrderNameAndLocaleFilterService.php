 ...
 */
class getTranslationOrderNameAndLocaleFilterService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/ApiBundle/Filter/Doctrine/TranslationOrderNameAndLocaleFilter.php';

        return $container->services['Sylius\\Bundle\\ApiBundle\\Filter\\Doctrine\\TranslationOrderNameAndLocaleFilter'] = new \Sylius\Bundle\ApiBundle\Filter\Doctrine\TranslationOrderNameAndLocaleFilter(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
