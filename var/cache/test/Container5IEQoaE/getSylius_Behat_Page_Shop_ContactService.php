 ...
 */
class getSylius_Behat_Page_Shop_ContactService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.shop.contact' shared service.
     *
     * @return \Sylius\Behat\Page\Shop\Contact\ContactPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Contact/ContactPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Contact/ContactPage.php';

        return $container->privates['sylius.behat.page.shop.contact'] = new \Sylius\Behat\Page\Shop\Contact\ContactPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()));
    }
}
