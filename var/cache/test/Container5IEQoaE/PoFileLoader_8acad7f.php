...
{
    /**
     * @var \Symfony\Component\Translation\Loader\PoFileLoader|null wrapped object, if the proxy is initialized
     */
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Symfony\\Component\\Translation\\Loader\\PoFileLoader');
...
if (!\class_exists('PoFileLoader_8acad7f', false)) {
    \class_alias(__NAMESPACE__.'\\PoFileLoader_8acad7f', 'PoFileLoader_8acad7f', false);
}
