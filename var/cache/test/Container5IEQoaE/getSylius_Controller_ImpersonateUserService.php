 ...
 */
class getSylius_Controller_ImpersonateUserService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/AdminBundle/Controller/ImpersonateUserController.php';
