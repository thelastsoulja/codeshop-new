 ...
 */
class getSylius_Behat_Page_Shop_Account_Order_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.shop.account.order.index' shared service.
     *
     * @return \Sylius\Behat\Page\Shop\Account\Order\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Account/Order/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Account/Order/IndexPage.php';
