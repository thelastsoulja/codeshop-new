 ...
 */
class getSylius_Behat_Page_Admin_Channel_CreateService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.channel.create' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Channel\CreatePage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Channel/CreatePageInterface.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Behaviour/DescribesIt.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Behaviour/Toggles.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Channel/CreatePage.php';

        return $container->privates['sylius.behat.page.admin.channel.create'] = new \Sylius\Behat\Page\Admin\Channel\CreatePage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()), 'sylius_admin_channel_create');
    }
}
