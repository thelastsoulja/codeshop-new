 ...
 */
class getSylius_Behat_Page_Admin_ProductAssociationType_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.product_association_type.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\ProductAssociationType\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ProductAssociationType/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ProductAssociationType/IndexPage.php';
