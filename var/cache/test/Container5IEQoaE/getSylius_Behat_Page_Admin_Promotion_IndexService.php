 ...
 */
class getSylius_Behat_Page_Admin_Promotion_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.promotion.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Promotion\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Promotion/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Promotion/IndexPage.php';
