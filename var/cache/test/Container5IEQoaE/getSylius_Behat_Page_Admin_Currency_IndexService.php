 ...
 */
class getSylius_Behat_Page_Admin_Currency_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.currency.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Currency\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Currency/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Currency/IndexPage.php';
