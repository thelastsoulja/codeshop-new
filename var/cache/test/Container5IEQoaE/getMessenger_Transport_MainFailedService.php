 ...
 */
class getMessenger_Transport_MainFailedService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport.main_failed'] = $a->createTransport($container->getEnv('resolve:SYLIUS_MESSENGER_TRANSPORT_MAIN_FAILED_DSN'), ['transport_name' => 'main_failed'], ($container->privates['messenger.transport.native_php_serializer'] ?? ($container->privates['messenger.transport.native_php_serializer'] = new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer())));
    }
}
