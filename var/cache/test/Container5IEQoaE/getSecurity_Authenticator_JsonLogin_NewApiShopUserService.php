 ...
 */
class getSecurity_Authenticator_JsonLogin_NewApiShopUserService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['security.authentication.success_handler.new_api_shop_user.json_login'] ?? $container->load('getSecurity_Authentication_SuccessHandler_NewApiShopUser_JsonLoginService'));

        if (isset($container->privates['security.authenticator.json_login.new_api_shop_user'])) {
            return $container->privates['security.authenticator.json_login.new_api_shop_user'];
        }
        $c = ($container->privates['security.authentication.failure_handler.new_api_shop_user.json_login'] ?? $container->load('getSecurity_Authentication_FailureHandler_NewApiShopUser_JsonLoginService'));

        if (isset($container->privates['security.authenticator.json_login.new_api_shop_user'])) {
            return $container->privates['security.authenticator.json_login.new_api_shop_user'];
        }

        $container->privates['security.authenticator.json_login.new_api_shop_user'] = $instance = new \Symfony\Component\Security\Http\Authenticator\JsonLoginAuthenticator($a, ($container->privates['sylius.shop_user_provider.email_or_name_based'] ?? $container->load('getSylius_ShopUserProvider_EmailOrNameBasedService')), $b, $c, ['check_path' => '/api/v2/shop/authentication-token', 'username_path' => 'email', 'password_path' => 'password', 'use_forward' => false, 'require_previous_session' => false, 'login_path' => '/login'], ($container->privates['property_accessor'] ?? $container->getPropertyAccessorService()));
