...
class getFosRest_Serializer_FormErrorHandler_InnerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['fos_rest.serializer.form_error_handler.inner'] = new \JMS\Serializer\Handler\FormErrorHandler(($container->services['translator'] ?? $container->getTranslatorService()), 'validators');
    }
}
