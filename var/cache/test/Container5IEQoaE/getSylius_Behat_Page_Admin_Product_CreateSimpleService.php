 ...
 */
class getSylius_Behat_Page_Admin_Product_CreateSimpleService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.product.create_simple' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Product\CreateSimpleProductPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Product/CreateSimpleProductPageInterface.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Product/CreateSimpleProductPage.php';

        return $container->privates['sylius.behat.page.admin.product.create_simple'] = new \Sylius\Behat\Page\Admin\Product\CreateSimpleProductPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()), 'sylius_admin_product_create');
    }
}
