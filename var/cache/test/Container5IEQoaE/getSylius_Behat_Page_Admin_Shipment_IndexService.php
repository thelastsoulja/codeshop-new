 ...
 */
class getSylius_Behat_Page_Admin_Shipment_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.shipment.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Shipment\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Shipment/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Shipment/IndexPage.php';
