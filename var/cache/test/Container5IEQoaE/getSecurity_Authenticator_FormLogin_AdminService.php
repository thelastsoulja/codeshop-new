 ...
 */
class getSecurity_Authenticator_FormLogin_AdminService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['security.authentication.success_handler.admin.form_login'] ?? $container->load('getSecurity_Authentication_SuccessHandler_Admin_FormLoginService'));

        if (isset($container->privates['security.authenticator.form_login.admin'])) {
            return $container->privates['security.authenticator.form_login.admin'];
        }
        $c = ($container->privates['security.authentication.failure_handler.admin.form_login'] ?? $container->load('getSecurity_Authentication_FailureHandler_Admin_FormLoginService'));

        if (isset($container->privates['security.authenticator.form_login.admin'])) {
            return $container->privates['security.authenticator.form_login.admin'];
        }

        return $container->privates['security.authenticator.form_login.admin'] = new \Symfony\Component\Security\Http\Authenticator\FormLoginAuthenticator($a, ($container->privates['sylius.admin_user_provider.email_or_name_based'] ?? $container->load('getSylius_AdminUserProvider_EmailOrNameBasedService')), $b, $c, ['login_path' => 'sylius_admin_login', 'check_path' => 'sylius_admin_login_check', 'use_forward' => false, 'enable_csrf' => true, 'csrf_parameter' => '_csrf_admin_security_token', 'csrf_token_id' => 'admin_authenticate', 'require_previous_session' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'post_only' => true, 'form_only' => false]);
    }
}
