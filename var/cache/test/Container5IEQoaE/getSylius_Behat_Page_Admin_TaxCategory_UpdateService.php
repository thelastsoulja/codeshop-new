 ...
 */
class getSylius_Behat_Page_Admin_TaxCategory_UpdateService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.tax_category.update' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\TaxCategory\UpdatePage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/TaxCategory/UpdatePageInterface.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/TaxCategory/UpdatePage.php';

        return $container->privates['sylius.behat.page.admin.tax_category.update'] = new \Sylius\Behat\Page\Admin\TaxCategory\UpdatePage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()), 'sylius_admin_tax_category_update');
    }
}
