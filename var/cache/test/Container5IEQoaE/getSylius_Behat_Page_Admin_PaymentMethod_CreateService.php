 ...
 */
class getSylius_Behat_Page_Admin_PaymentMethod_CreateService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.payment_method.create' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\PaymentMethod\CreatePage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/PaymentMethod/CreatePageInterface.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/PaymentMethod/CreatePage.php';

        return $container->privates['sylius.behat.page.admin.payment_method.create'] = new \Sylius\Behat\Page\Admin\PaymentMethod\CreatePage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()), 'sylius_admin_payment_method_create');
    }
}
