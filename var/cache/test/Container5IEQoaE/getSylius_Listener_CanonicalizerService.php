 ...
 */
class getSylius_Listener_CanonicalizerService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/CoreBundle/EventListener/CanonicalizerListener.php';
