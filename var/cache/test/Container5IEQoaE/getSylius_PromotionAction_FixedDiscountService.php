 ...
 */
class getSylius_PromotionAction_FixedDiscountService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Component/Core/Promotion/Action/FixedDiscountPromotionActionCommand.php';
        ...
        $a = ($container->services['sylius.currency_converter'] ?? $container->getSylius_CurrencyConverterService());
