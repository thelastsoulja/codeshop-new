 ...
 */
class getSylius_FormRegistry_AttributeTypeService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add('float', 'default', 'Sylius\\Bundle\\AttributeBundle\\Form\\Type\\AttributeType\\FloatAttributeType');
