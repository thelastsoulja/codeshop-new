 ...
 */
class getSylius_Behat_Page_Admin_Product_IndexPerTaxonService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.product.index_per_taxon' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Product\IndexPerTaxonPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Product/IndexPerTaxonPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Product/IndexPerTaxonPage.php';
