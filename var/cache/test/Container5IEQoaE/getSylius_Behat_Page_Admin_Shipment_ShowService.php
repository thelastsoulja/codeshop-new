 ...
 */
class getSylius_Behat_Page_Admin_Shipment_ShowService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.shipment.show' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Shipment\ShowPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Shipment/ShowPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Shipment/ShowPage.php';

        return $container->privates['sylius.behat.page.admin.shipment.show'] = new \Sylius\Behat\Page\Admin\Shipment\ShowPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()));
    }
}
