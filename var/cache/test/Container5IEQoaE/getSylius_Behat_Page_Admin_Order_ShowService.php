 ...
 */
class getSylius_Behat_Page_Admin_Order_ShowService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.order.show' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Order\ShowPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Order/ShowPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Order/ShowPage.php';
