 ...
 */
class getSylius_Api_ChannelPricingProductVariantFilterService extends App_KernelTestDebugContainer
{
    /**
     * Gets the public 'sylius.api.channel_pricing_product_variant_filter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sylius.api.channel_pricing_product_variant_filter'])) {
            return $container->services['sylius.api.channel_pricing_product_variant_filter'];
        }

        return $container->services['sylius.api.channel_pricing_product_variant_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), NULL, $a, ($container->privates['property_accessor'] ?? $container->getPropertyAccessorService()), ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()), ['channelPricing.productVariant.code' => 'exact'], ($container->privates['api_platform.identifiers_extractor.cached'] ?? $container->getApiPlatform_IdentifiersExtractor_CachedService()), ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
