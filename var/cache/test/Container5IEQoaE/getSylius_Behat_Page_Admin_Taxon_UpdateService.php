 ...
 */
class getSylius_Behat_Page_Admin_Taxon_UpdateService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.taxon.update' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Taxon\UpdatePage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Taxon/UpdatePageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Behaviour/ChecksCodeImmutability.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Taxon/UpdatePage.php';

        return $container->privates['sylius.behat.page.admin.taxon.update'] = new \Sylius\Behat\Page\Admin\Taxon\UpdatePage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()), 'sylius_admin_taxon_update');
    }
}
