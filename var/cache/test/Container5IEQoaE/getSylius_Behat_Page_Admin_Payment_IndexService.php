 ...
 */
class getSylius_Behat_Page_Admin_Payment_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.payment.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Payment\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Payment/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Payment/IndexPage.php';
