 ...
 */
class getSylius_Behat_Page_Admin_ExchangeRate_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.exchange_rate.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\ExchangeRate\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ExchangeRate/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ExchangeRate/IndexPage.php';
