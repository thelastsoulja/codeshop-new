 ...
 */
class getSecurity_EventDispatcher_NewApiAdminUserService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'security.event_dispatcher.new_api_admin_user' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->privates['security.event_dispatcher.new_api_admin_user'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.new_api_admin_user.user_provider'] ?? $container->load('getSecurity_Listener_NewApiAdminUser_UserProviderService'));
        }, 1 => 'checkPassport'], 2048);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.user_checker.new_api_admin_user'] ?? $container->load('getSecurity_Listener_UserChecker_NewApiAdminUserService'));
