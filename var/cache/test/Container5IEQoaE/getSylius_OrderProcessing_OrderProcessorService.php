 ...
 */
class getSylius_OrderProcessing_OrderProcessorService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Component/Order/Processor/CompositeOrderProcessor.php';
