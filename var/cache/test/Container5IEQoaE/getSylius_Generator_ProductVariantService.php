 ...
 */
class getSylius_Generator_ProductVariantService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Sylius/Component/Product/Generator/ProductVariantGeneratorInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Component/Product/Generator/ProductVariantGenerator.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Component/Product/Checker/ProductVariantsParityCheckerInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Component/Product/Checker/ProductVariantsParityChecker.php';
