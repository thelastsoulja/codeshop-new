 ...
 */
class getSylius_Doctrine_Orm_EventSubscriber_LoadMetadata_ReviewService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/ReviewBundle/Doctrine/ORM/Subscriber/LoadMetadataSubscriber.php';
