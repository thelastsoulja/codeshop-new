 ...
 */
class getSylius_Behat_Page_Admin_ChannelPricingLogEntry_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the public 'sylius.behat.page.admin.channel_pricing_log_entry.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\ChannelPricingLogEntry\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ChannelPricingLogEntry/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ChannelPricingLogEntry/IndexPage.php';
