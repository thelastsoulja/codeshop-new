 ...
 */
class getSonata_Block_Service_RssService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sonata.block.service.rss' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['sonata.block.service.rss'])) {
            return $container->privates['sonata.block.service.rss'];
        }

        return $container->privates['sonata.block.service.rss'] = new \Sonata\BlockBundle\Block\Service\RssBlockService($a);
    }
}
