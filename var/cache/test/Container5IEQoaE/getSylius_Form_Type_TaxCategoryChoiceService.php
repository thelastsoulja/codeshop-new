 ...
 */
class getSylius_Form_Type_TaxCategoryChoiceService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/TaxationBundle/Form/Type/TaxCategoryChoiceType.php';
