 ...
 */
class getSylius_PromotionCouponGenerator_PercentagePolicyService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Sylius/Component/Promotion/Generator/GenerationPolicyInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Component/Promotion/Generator/PercentageGenerationPolicy.php';
