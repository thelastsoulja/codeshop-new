 ...
 */
class getDebug_Security_Firewall_Authenticator_NewApiShopUserService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['debug.security.firewall.authenticator.new_api_shop_user.inner'] ?? $container->load('getDebug_Security_Firewall_Authenticator_NewApiShopUser_InnerService'));
        ...
        return $container->privates['debug.security.firewall.authenticator.new_api_shop_user'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticatorManagerListener($a);
    }
}
