 ...
 */
class getProductVariantEventSubscriberService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/ApiBundle/EventSubscriber/ProductVariantEventSubscriber.php';
