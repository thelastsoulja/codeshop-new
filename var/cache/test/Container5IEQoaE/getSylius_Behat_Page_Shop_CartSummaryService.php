 ...
 */
class getSylius_Behat_Page_Shop_CartSummaryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.shop.cart_summary' shared service.
     *
     * @return \Sylius\Behat\Page\Shop\Cart\SummaryPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Cart/SummaryPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Cart/SummaryPage.php';

        return $container->privates['sylius.behat.page.shop.cart_summary'] = new \Sylius\Behat\Page\Shop\Cart\SummaryPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()));
    }
}
