...
{
    /**
     * @var \Symfony\Component\Translation\Loader\MoFileLoader|null wrapped object, if the proxy is initialized
     */
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Symfony\\Component\\Translation\\Loader\\MoFileLoader');
...
if (!\class_exists('MoFileLoader_067a4cd', false)) {
    \class_alias(__NAMESPACE__.'\\MoFileLoader_067a4cd', 'MoFileLoader_067a4cd', false);
}
