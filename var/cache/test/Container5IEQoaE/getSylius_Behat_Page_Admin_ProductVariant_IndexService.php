 ...
 */
class getSylius_Behat_Page_Admin_ProductVariant_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.product_variant.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\ProductVariant\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ProductVariant/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ProductVariant/IndexPage.php';
