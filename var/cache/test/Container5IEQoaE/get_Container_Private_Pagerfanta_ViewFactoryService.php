...
class get_Container_Private_Pagerfanta_ViewFactoryService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->set('default', ($container->privates['pagerfanta.view.default'] ?? ($container->privates['pagerfanta.view.default'] = new \Pagerfanta\View\DefaultView())));
        $instance->set('foundation6', ($container->privates['pagerfanta.view.foundation6'] ?? ($container->privates['pagerfanta.view.foundation6'] = new \Pagerfanta\View\Foundation6View())));
        $instance->set('semantic_ui', ($container->privates['pagerfanta.view.semantic_ui'] ?? ($container->privates['pagerfanta.view.semantic_ui'] = new \Pagerfanta\View\SemanticUiView())));
        $instance->set('twitter_bootstrap', ($container->privates['pagerfanta.view.twitter_bootstrap'] ?? ($container->privates['pagerfanta.view.twitter_bootstrap'] = new \Pagerfanta\View\TwitterBootstrapView())));
        $instance->set('twitter_bootstrap3', ($container->privates['pagerfanta.view.twitter_bootstrap3'] ?? ($container->privates['pagerfanta.view.twitter_bootstrap3'] = new \Pagerfanta\View\TwitterBootstrap3View())));
        $instance->set('twitter_bootstrap4', ($container->privates['pagerfanta.view.twitter_bootstrap4'] ?? ($container->privates['pagerfanta.view.twitter_bootstrap4'] = new \Pagerfanta\View\TwitterBootstrap4View())));
        $instance->set('twitter_bootstrap5', ($container->privates['pagerfanta.view.twitter_bootstrap5'] ?? ($container->privates['pagerfanta.view.twitter_bootstrap5'] = new \Pagerfanta\View\TwitterBootstrap5View())));
