 ...
 */
class getDemoteUserCommandService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/UserBundle/Command/DemoteUserCommand.php';
