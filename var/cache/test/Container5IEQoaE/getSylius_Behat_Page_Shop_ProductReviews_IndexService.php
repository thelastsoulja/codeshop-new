 ...
 */
class getSylius_Behat_Page_Shop_ProductReviews_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.shop.product_reviews.index' shared service.
     *
     * @return \Sylius\Behat\Page\Shop\ProductReview\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/ProductReview/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/ProductReview/IndexPage.php';

        return $container->privates['sylius.behat.page.shop.product_reviews.index'] = new \Sylius\Behat\Page\Shop\ProductReview\IndexPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()));
    }
}
