 ...
 */
class getSylius_Behat_Page_Admin_DashboardService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.dashboard' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\DashboardPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/DashboardPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/DashboardPage.php';
