 ...
 */
class getSylius_Fixture_ExampleFactory_ShopUserService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/CoreBundle/Fixture/Factory/ShopUserExampleFactory.php';
