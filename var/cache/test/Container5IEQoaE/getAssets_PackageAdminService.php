 ...
 */
class getAssets_PackageAdminService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        return $container->privates['assets._package_admin'] = new \Sylius\Bundle\ThemeBundle\Asset\Package\PathPackage('', ($container->privates['assets._version_admin'] ?? $container->load('getAssets_VersionAdminService')), ($container->privates['sylius.theme.context.channel_based'] ?? $container->getSylius_Theme_Context_ChannelBasedService()), ($container->privates['Sylius\\Bundle\\ThemeBundle\\Asset\\PathResolverInterface'] ?? $container->getPathResolverInterfaceService()), ($container->privates['assets.context'] ?? $container->getAssets_ContextService()));
    }
}
