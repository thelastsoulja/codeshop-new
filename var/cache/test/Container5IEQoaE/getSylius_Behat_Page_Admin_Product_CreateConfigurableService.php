 ...
 */
class getSylius_Behat_Page_Admin_Product_CreateConfigurableService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.product.create_configurable' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Product\CreateConfigurableProductPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Product/CreateConfigurableProductPageInterface.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Product/CreateConfigurableProductPage.php';

        return $container->privates['sylius.behat.page.admin.product.create_configurable'] = new \Sylius\Behat\Page\Admin\Product\CreateConfigurableProductPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()), 'sylius_admin_product_create');
    }
}
