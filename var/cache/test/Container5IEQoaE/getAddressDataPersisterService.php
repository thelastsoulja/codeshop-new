 ...
 */
class getAddressDataPersisterService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/ApiBundle/DataPersister/AddressDataPersister.php';

        return $container->services['Sylius\\Bundle\\ApiBundle\\DataPersister\\AddressDataPersister'] = new \Sylius\Bundle\ApiBundle\DataPersister\AddressDataPersister(($container->privates['api_platform.doctrine.orm.data_persister'] ?? $container->load('getApiPlatform_Doctrine_Orm_DataPersisterService')), ($container->services['Sylius\\Bundle\\ApiBundle\\Context\\UserContextInterface'] ?? $container->getUserContextInterfaceService()));
    }
}
