 ...
 */
class getDebug_Security_Firewall_Authenticator_AdminService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['debug.security.firewall.authenticator.admin.inner'] ?? $container->load('getDebug_Security_Firewall_Authenticator_Admin_InnerService'));
        ...
        return $container->privates['debug.security.firewall.authenticator.admin'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticatorManagerListener($a);
    }
}
