 ...
 */
class getSylius_Behat_Page_Shop_Order_ThankYouService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.shop.order.thank_you' shared service.
     *
     * @return \Sylius\Behat\Page\Shop\Order\ThankYouPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Order/ThankYouPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Order/ThankYouPage.php';

        return $container->privates['sylius.behat.page.shop.order.thank_you'] = new \Sylius\Behat\Page\Shop\Order\ThankYouPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()));
    }
}
