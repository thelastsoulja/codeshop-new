 ...
 */
class getSylius_Api_ProductAssociationFilterService extends App_KernelTestDebugContainer
{
    /**
     * Gets the public 'sylius.api.product_association_filter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sylius.api.product_association_filter'])) {
            return $container->services['sylius.api.product_association_filter'];
        }

        return $container->services['sylius.api.product_association_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), NULL, $a, ($container->privates['property_accessor'] ?? $container->getPropertyAccessorService()), ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()), ['owner.code' => 'partial', 'type.code' => 'partial'], ($container->privates['api_platform.identifiers_extractor.cached'] ?? $container->getApiPlatform_IdentifiersExtractor_CachedService()), ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
