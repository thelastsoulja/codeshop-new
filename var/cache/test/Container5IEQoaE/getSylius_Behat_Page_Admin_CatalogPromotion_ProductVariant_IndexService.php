 ...
 */
class getSylius_Behat_Page_Admin_CatalogPromotion_ProductVariant_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.catalog_promotion.product_variant.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\CatalogPromotion\ProductVariant\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/CatalogPromotion/ProductVariant/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/CatalogPromotion/ProductVariant/IndexPage.php';
