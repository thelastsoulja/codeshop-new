 ...
 */
class getSylius_Behat_Page_Shop_Account_RegisterService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.shop.account.register' shared service.
     *
     * @return \Sylius\Behat\Page\Shop\Account\RegisterPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Account/RegisterPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Account/RegisterPage.php';

        return $container->privates['sylius.behat.page.shop.account.register'] = new \Sylius\Behat\Page\Shop\Account\RegisterPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()));
    }
}
