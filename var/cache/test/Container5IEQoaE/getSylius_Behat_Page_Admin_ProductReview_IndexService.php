 ...
 */
class getSylius_Behat_Page_Admin_ProductReview_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.product_review.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\ProductReview\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ProductReview/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ProductReview/IndexPage.php';
