 ...
 */
class getSylius_Behat_Page_Admin_Taxon_CreateForParentService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.taxon.create_for_parent' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Taxon\CreateForParentPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Taxon/CreatePageInterface.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Taxon/CreatePage.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Taxon/CreateForParentPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Taxon/CreateForParentPage.php';

        return $container->privates['sylius.behat.page.admin.taxon.create_for_parent'] = new \Sylius\Behat\Page\Admin\Taxon\CreateForParentPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()), 'sylius_admin_taxon_create', 'sylius_admin_taxon_create');
    }
}
