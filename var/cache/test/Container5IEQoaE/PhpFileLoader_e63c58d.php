...
{
    /**
     * @var \Symfony\Component\Translation\Loader\PhpFileLoader|null wrapped object, if the proxy is initialized
     */
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Symfony\\Component\\Translation\\Loader\\PhpFileLoader');
...
if (!\class_exists('PhpFileLoader_e63c58d', false)) {
    \class_alias(__NAMESPACE__.'\\PhpFileLoader_e63c58d', 'PhpFileLoader_e63c58d', false);
}
