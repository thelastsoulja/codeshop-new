...
class getNelmioAlice_FileParser_RuntimeCacheService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_alice.file_parser.runtime_cache'] = new \Nelmio\Alice\Parser\RuntimeCacheParser(($container->privates['nelmio_alice.file_parser.registry'] ?? $container->load('getNelmioAlice_FileParser_RegistryService')), ($container->privates['nelmio_alice.file_locator.default'] ?? ($container->privates['nelmio_alice.file_locator.default'] = new \Nelmio\Alice\FileLocator\DefaultFileLocator())), ($container->privates['nelmio_alice.file_parser.default_include_processor'] ?? $container->load('getNelmioAlice_FileParser_DefaultIncludeProcessorService')));
    }
}
