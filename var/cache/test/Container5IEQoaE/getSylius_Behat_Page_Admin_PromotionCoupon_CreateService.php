 ...
 */
class getSylius_Behat_Page_Admin_PromotionCoupon_CreateService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.promotion_coupon.create' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\PromotionCoupon\CreatePage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/PromotionCoupon/CreatePageInterface.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/PromotionCoupon/CreatePage.php';

        return $container->privates['sylius.behat.page.admin.promotion_coupon.create'] = new \Sylius\Behat\Page\Admin\PromotionCoupon\CreatePage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()), 'sylius_admin_promotion_coupon_create');
    }
}
