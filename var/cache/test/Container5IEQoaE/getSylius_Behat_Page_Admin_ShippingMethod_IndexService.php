 ...
 */
class getSylius_Behat_Page_Admin_ShippingMethod_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.shipping_method.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\ShippingMethod\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ShippingMethod/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/ShippingMethod/IndexPage.php';
