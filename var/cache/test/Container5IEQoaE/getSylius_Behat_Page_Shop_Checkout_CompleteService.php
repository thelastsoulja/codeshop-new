 ...
 */
class getSylius_Behat_Page_Shop_Checkout_CompleteService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.shop.checkout.complete' shared service.
     *
     * @return \Sylius\Behat\Page\Shop\Checkout\CompletePage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Checkout/CompletePageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Checkout/CompletePage.php';
