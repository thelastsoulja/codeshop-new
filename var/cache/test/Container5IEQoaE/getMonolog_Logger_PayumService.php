 ...
 */
class getMonolog_Logger_PayumService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        $container->privates['monolog.logger.payum'] = $instance = new \Symfony\Bridge\Monolog\Logger('payum');
