 ...
 */
class getSylius_Behat_Page_Admin_Promotion_CreateService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.promotion.create' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Promotion\CreatePage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Promotion/CreatePageInterface.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Promotion/CreatePage.php';

        return $container->privates['sylius.behat.page.admin.promotion.create'] = new \Sylius\Behat\Page\Admin\Promotion\CreatePage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()), 'sylius_admin_promotion_create');
    }
}
