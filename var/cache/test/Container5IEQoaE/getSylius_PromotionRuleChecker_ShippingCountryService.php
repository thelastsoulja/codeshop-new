 ...
 */
class getSylius_PromotionRuleChecker_ShippingCountryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Component/Core/Promotion/Checker/Rule/ShippingCountryRuleChecker.php';
