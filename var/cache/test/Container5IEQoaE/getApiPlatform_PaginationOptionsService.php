...
class getApiPlatform_PaginationOptionsService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.pagination_options'] = new \ApiPlatform\State\Pagination\PaginationOptions(true, 'page', true, 'itemsPerPage', false, 'pagination', 30, NULL, false, false, 'partial');
    }
}
