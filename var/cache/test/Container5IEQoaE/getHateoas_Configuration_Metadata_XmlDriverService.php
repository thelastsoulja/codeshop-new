...
class getHateoas_Configuration_Metadata_XmlDriverService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['hateoas.configuration.metadata.xml_driver'] = new \Hateoas\Configuration\Metadata\Driver\XmlDriver(($container->privates['jms_serializer.metadata.traceable_file_locator'] ?? $container->getJmsSerializer_Metadata_TraceableFileLocatorService()), ($container->privates['jms_serializer.expression_evaluator'] ?? $container->getJmsSerializer_ExpressionEvaluatorService()), ($container->services['hateoas.configuration.provider'] ?? $container->load('getHateoas_Configuration_ProviderService')), ($container->privates['jms_serializer.type_parser'] ?? ($container->privates['jms_serializer.type_parser'] = new \JMS\Serializer\Type\Parser())));
    }
}
