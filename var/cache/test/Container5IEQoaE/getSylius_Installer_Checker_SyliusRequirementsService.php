 ...
 */
class getSylius_Installer_Checker_SyliusRequirementsService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/CoreBundle/Installer/Checker/RequirementsCheckerInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/CoreBundle/Installer/Checker/SyliusRequirementsChecker.php';
