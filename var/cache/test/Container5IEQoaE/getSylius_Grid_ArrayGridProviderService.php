...
class getSylius_Grid_ArrayGridProviderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.grid.array_grid_provider'] = new \Sylius\Component\Grid\Provider\ArrayGridProvider(($container->services['sylius.grid.array_to_definition_converter'] ?? $container->load('getSylius_Grid_ArrayToDefinitionConverterService')), $container->parameters['sylius.grids_definitions'], ($container->services['sylius.grid.configuration_extender'] ?? ($container->services['sylius.grid.configuration_extender'] = new \Sylius\Component\Grid\Configuration\GridConfigurationExtender())), ($container->services['sylius.grid.configuration_removals_handler'] ?? ($container->services['sylius.grid.configuration_removals_handler'] = new \Sylius\Component\Grid\Configuration\GridConfigurationRemovalsHandler())));
    }
}
