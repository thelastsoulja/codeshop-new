 ...
 */
class getSylius_Behat_Page_Admin_Customer_ShowService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.customer.show' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Customer\ShowPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Customer/ShowPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Customer/ShowPage.php';

        return $container->privates['sylius.behat.page.admin.customer.show'] = new \Sylius\Behat\Page\Admin\Customer\ShowPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()));
    }
}
