 ...
 */
class getSylius_Behat_Page_Admin_Customer_IndexService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.admin.customer.index' shared service.
     *
     * @return \Sylius\Behat\Page\Admin\Customer\IndexPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Customer/IndexPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Admin/Customer/IndexPage.php';
