 ...
 */
class getSylius_Behat_Page_Shop_Account_LoginService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'sylius.behat.page.shop.account.login' shared service.
     *
     * @return \Sylius\Behat\Page\Shop\Account\LoginPage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Account/LoginPageInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Behat/Page/Shop/Account/LoginPage.php';

        return $container->privates['sylius.behat.page.shop.account.login'] = new \Sylius\Behat\Page\Shop\Account\LoginPage(($container->services['behat.mink.default_session'] ?? $container->load('getBehat_Mink_DefaultSessionService')), ($container->services['behat.mink.parameters'] ?? $container->load('getBehat_Mink_ParametersService')), ($container->services['router'] ?? $container->getRouterService()));
    }
}
