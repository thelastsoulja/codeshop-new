 ...
 */
class getSylius_Form_Type_TaxCalculationStrategyChoiceService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/CoreBundle/Form/Type/TaxCalculationStrategyChoiceType.php';
