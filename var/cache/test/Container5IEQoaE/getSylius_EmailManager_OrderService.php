 ...
 */
class getSylius_EmailManager_OrderService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/ShopBundle/EmailManager/OrderEmailManagerInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Sylius/Bundle/ShopBundle/EmailManager/OrderEmailManager.php';
